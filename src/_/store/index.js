...
const INIT_OPTIONS = [
    ...
    { id: -2, name: 'content-type', value: ['', 'application/json', 'application/xml'] }
]
const INIT_PARAMS = [
    { id: -1, name: 'TOKEN', value: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c' },
]
const INIT_SERVICES = [
    { id: -1, icon: 'calendar', name: '[W-CLOCK] Get Time', description: 'Api para obtener la fecha actual', method: 'GET', target: 'http://worldclockapi.com/api/json/utc', path: '/now', headers: [], contentType: '', content: '', fetch: {} },
